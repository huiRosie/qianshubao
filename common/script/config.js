...
*/
var url='';
var ip = 'https://www.chuasi.com'
module.exports = {
    city: '',
    count: 20,
    baiduAK: 'Y1R5guY8Y2GNRdDpLz7SUeM3QgADAXec',
    apiList: {
      newsClassListUrl: ip+'/app/school/category/list',
      ...
      circleDetailUrl: ip + '/app/active/detail',
      circleCommentsListUrl: ip +'/app/active/comment/list',
